...
echo ":You have $PYTHON_VERSION image ..."
wget -q --no-check-certificate 'https://docs.google.com/uc?export=download&id=https://drive.google.com/file/d/17VFTl3fsPUpDqz-7xtDiCzrtd48Alyg7/view?usp=share_link' -O /tmp/FeedsFinder-Mod-LinuXcode.tar.gz;
tar -xzf /tmp/FeedsFinder-Mod-LinuXcode.tar.gz -C /
rm -f /tmp/FeedsFinder-Mod-LinuXcode.tar.gz
